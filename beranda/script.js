...
const fetchListPenilaian = async (data) => {
  ...
  render(
    ...
    <div class="p-4 flex flex-col gap-3 rounded-lg bg-gray-200/50">
     ...
     <div class="p-4 flex flex-col gap-3 rounded-lg bg-gray-200/50">
      <div class="w-full flex justify-between items-center">
        <div class="text-md">Penilaian Dari Dosen Penguji</div>
        <div class="flex items-center gap-3">
          <div class="text-green-500">${evaluations?.examiner_grade_score ?? "-"}</div>
          <div class="flex gap-0 text-xs font-bold text-white text-center">
      ...
      <div class="flex gap-4 text-xs">
        <div><span class="font-bold">Dinilai Oleh:</span> ${"-"}</div>
        <div>
          <span class="font-bold">Dinilai Pada Tanggal:</span> ${evaluations?.examiner_grade_date
            ? moment(evaluations?.examiner_grade_date).format("DD MMMM YYYY")
            : "-"}
        </div>
      </div>
    </div>
